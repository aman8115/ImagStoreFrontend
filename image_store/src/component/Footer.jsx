...
function Footer(){
    ...
    return(
        ...
        <div>
            <h5 className='text-xl font-semibold left-2 w-fit tracking-wider'> Copy Right &copy;{year} All Right Resrved </h5>
        </div>
          <div className='flex gap-4 flex-col items-center justify-center sm:flex sm:flex-row'>
